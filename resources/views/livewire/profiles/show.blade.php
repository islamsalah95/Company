                ...
                <div class="card mb-4">
                    ...
                    <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                            <img src="{{ asset($authUser->emp_photo_file) }}" alt="{{ asset($authUser->emp_photo_file) }}" class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img">
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-4 mt-3">
                            <li class="d-flex align-items-center mb-3">
                                working hours:</span> <span>{{$contract->working_hours}}</span>
                            </li>
                            <li class="d-flex align-items-center mb-3">
                                working hours per day:</span> <span>{{$contract->working_hours_per_day}}</span>
                            </li>
                            <li class="d-flex align-items-center mb-3">
                                working hours per week:</span> <span>{{$contract->working_hours_per_week}}</span>
                            </li>
                            <li class="d-flex align-items-center mb-3">
                                hourly rate:</span> <span>{{$contract->hourly_rate}}</span>
                            </li>
                            <li class="d-flex align-items-center mb-3">
                                start date:</span> <span>{{$contract->start_date}}</span>
                            </li>
                            <li class="d-flex align-items-center mb-3">
                                end date:</span> <span>{{$contract->end_date}}</span>
                            </li>
                            <li class="d-flex align-items-center mb-3">
                                start date:</span> <span>{{$contract->created_at}}</span>
                            </li>
                        </ul>
